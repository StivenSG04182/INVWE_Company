...
export const useEmailEditorStore = () => {
    ...
    const addElement = (element: EmailElement, parentId?: string) => {
        dispatch({ type: "ADD_ELEMENT", payload: { element, parentId } })
    }

    const updateElement = (id: string, element: EmailElement) => {
    ...
    const selectElement = (element: EmailElement | null) => {
        dispatch({ type: "SELECT_ELEMENT", payload: element })
    }

    const moveElement = (id: string, sourceParentId?: string, targetParentId?: string, targetIndex = 0) => {
        dispatch({ type: "MOVE_ELEMENT", payload: { id, sourceParentId, targetParentId, targetIndex } })
    }

    const duplicateElement = (element: EmailElement, parentId?: string) => {
    ...
    const loadTemplate = (elements: EmailElement[], templateId: string) => {
