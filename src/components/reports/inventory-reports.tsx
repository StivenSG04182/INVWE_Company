          ...
          <div className="flex flex-wrap gap-4">
            ...
            <DropdownMenu>
              ...
              <DropdownMenuContent>
                ...
                <DropdownMenuItem onClick={() => exportInventory("WORD")}>📝 Exportar Word</DropdownMenuItem>
                <DropdownMenuItem onClick={() => exportInventory("PNG")}>🖼️ Exportar PNG</DropdownMenuItem>
              </DropdownMenuContent>
            </DropdownMenu>
          </div>
        </CardContent>
