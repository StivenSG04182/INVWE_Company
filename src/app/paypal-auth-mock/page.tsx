...
export default function PayPalAuthMockPage() {
    ...
    const handleSubmit = (e: React.FormEvent) => {
        ...
        setTimeout(() => {
            ...
            const mockAuthCode = `mock_auth_${Date.now()}_${Math.random().toString(36).substring(2, 15)}`;
            ...
            <Card className="w-full max-w-md">
                <CardHeader className="space-y-1">
                    <div className="flex justify-center mb-4">
                        <div className="w-[150px] h-[60px] bg-blue-500 flex items-center justify-center text-white font-bold rounded">
                            PayPal
                        </div>
                    </div>
                    <CardTitle className="text-2xl text-center">Iniciar sesión en PayPal</CardTitle>
