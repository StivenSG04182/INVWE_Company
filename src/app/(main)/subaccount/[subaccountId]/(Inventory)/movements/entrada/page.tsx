...
export default async function EntradaPage({
  ...
  const pageData = await getEntryPageData(agencyId, searchParams.productId)

  return (
    <div className="container mx-auto p-6 space-y-8">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        <div>
          <h1 className="text-4xl font-bold tracking-tight">Entrada de Inventario</h1>
          <p className="text-muted-foreground mt-1">Registra la entrada de productos al inventario</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <Card className="bg-white dark:bg-gray-950 shadow-sm hover:shadow-md transition-shadow">
          ...
          <CardContent>
            <p className="text-sm text-muted-foreground">
              Registra la entrada de productos a tu inventario. Puedes añadir nuevos productos o aumentar el stock de
        ...
        <Card className="bg-white dark:bg-gray-950 shadow-sm hover:shadow-md transition-shadow">
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground mt-2">Productos disponibles para registrar entradas</p>
          </CardContent>
        </Card>
        ...
        <Card className="bg-white dark:bg-gray-950 shadow-sm hover:shadow-md transition-shadow">
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground mt-2">Áreas disponibles para almacenar productos</p>
          </CardContent>
        </Card>
      </div>
