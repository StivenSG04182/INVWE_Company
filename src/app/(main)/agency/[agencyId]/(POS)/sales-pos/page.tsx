        ...
        <Card className="lg:col-span-2">
          ...
          <CardContent className="pb-2">
            <div className="flex items-center justify-between mb-2">
              ...
              <span className="font-medium">${(cashRevenue / 1000).toFixed(3)}</span>
            </div>
            <Progress
            ...
            <div className="flex items-center justify-between mb-2">
              ...
              <span className="font-medium">${(cardRevenue / 1000).toFixed(3)}</span>
            </div>
            <Progress
          ...
          <CardFooter className="pt-0">
            <div className="flex justify-between w-full text-xs text-muted-foreground">
              <span>{cashSales} ventas en efectivo</span>
              <span>{cardSales} ventas con tarjeta</span>
            </div>
          </CardFooter>
        </Card>
            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-2">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-muted-foreground">10 Oct</p>
                  </div>
                </div>
                <div className="text-right">
                  <p className="text-sm font-medium">$120.000</p>
                  <p className="text-xs text-muted-foreground">8 ventas</p>
                </div>
              </div>
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-2">
                  ...
                  <div>
                    <p className="text-sm font-medium">Martes</p>
                    <p className="text-xs text-muted-foreground">11 Oct</p>
                  </div>
                </div>
                <div className="text-right">
                  <p className="text-sm font-medium">$95.000</p>
                  <p className="text-xs text-muted-foreground">6 ventas</p>
                </div>
              </div>
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-2">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-muted-foreground">12 Oct</p>
                  </div>
                </div>
                <div className="text-right">
                  <p className="text-sm font-medium">$135.000</p>
                  <p className="text-xs text-muted-foreground">9 ventas</p>
                </div>
              </div>
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-2">
                  ...
                  <div>
                    <p className="text-sm font-medium">Jueves</p>
                    <p className="text-xs text-muted-foreground">13 Oct</p>
                  </div>
                </div>
                <div className="text-right">
                  <p className="text-sm font-medium">$85.000</p>
                  <p className="text-xs text-muted-foreground">5 ventas</p>
                </div>
              </div>
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-2">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-muted-foreground">14 Oct</p>
                  </div>
                </div>
                <div className="text-right">
                  <p className="text-sm font-medium">$140.000</p>
