    ...
    <>
      <div className="flex items-center justify-between">
        <div className="flex items-center py-4 gap-2">
          <Search />
          <Input
            placeholder="Buscar nombre de comercio electrónico..."
            value={
        ...
        <Button
          ...
          onClick={() => {
            if (modalChildren)
              setOpen(
                <CustomModal
                  title="Crear un comercio electrónico"
                  subheading="El comercio electrónico es como una página web, ¡pero mejor! ¡Pruebe a crear uno!"
                >
                  {modalChildren}
                </CustomModal>
              )
