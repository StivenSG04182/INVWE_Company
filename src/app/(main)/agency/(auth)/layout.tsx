        ...
        <div className="relative w-full max-w-md">
          ...
          <div className="mt-8 text-center">
            <p className="text-xs text-gray-500 dark:text-gray-400">
              ...
              <a href="/site/terminos" className="text-blue-600 hover:text-blue-500 dark:text-blue-400">
                Términos de Servicio
              </a>{" "}
              y{" "}
              <a href="/site/condiciones" className="text-blue-600 hover:text-blue-500 dark:text-blue-400">
